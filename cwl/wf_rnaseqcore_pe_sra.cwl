...
outputs:
  ...
  output_unmapped_fastqc_r1_report:
    type: File
    outputSource: step_repunmapped_fastqc_trim_r1/output_qc_report
  output_unmapped_fastqc_r1_stats:
    type: File
    outputSource: step_repunmapped_fastqc_trim_r1/output_qc_stats
  
  output_unmapped_fastqc_r2_report:
    type: File
    outputSource: step_repunmapped_fastqc_trim_r2/output_qc_report
  output_unmapped_fastqc_r2_stats:
    type: File
    outputSource: step_repunmapped_fastqc_trim_r2/output_qc_stats
...
###########################################################################
  ...
  step_repunmapped_fastqc_trim_r1:
    run: wf_fastqc.cwl
    in:
      reads: 
        source: gzip_repunmapped_fastq/gzipped
        valueFrom: |
          ${
            return self[0];
          }
  ...
  step_repunmapped_fastqc_trim_r2:
    run: wf_fastqc.cwl
    in:
      reads: 
        source: gzip_repunmapped_fastq/gzipped
