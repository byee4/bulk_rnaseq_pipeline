...
outputs:
  ...
  output_unmapped_fastqc_r1_report:
    type: File[]
    outputSource: step_rnaseqcore_se/output_unmapped_fastqc_r1_report
  output_unmapped_fastqc_r1_stats:
    type: File[]
    outputSource: step_rnaseqcore_se/output_unmapped_fastqc_r1_stats
